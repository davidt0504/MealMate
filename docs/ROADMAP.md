...
- **Current implementation task:** none — `MVP-003` reached `Done` 2026-08-28; the implementation lane is clear.
- **Next implementation task:** `MVP-004` — `Ready`; every direct dependency (`MVP-002`, `MVP-003`) is `Done`.
...
| MVP-004 | Ready | Anonymous-first entry and household identity | MVP-002, MVP-003 |
