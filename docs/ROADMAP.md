...
- **Current implementation task:** None; the implementation lane is clear after `MVP-002` reached `Done`.
- **Next implementation task:** `MVP-003` — `Ready` for `plan-task` without `--auto`; implementation still requires a current approved plan and the execution gate.
...
| MVP-003 | Ready | Android shell and navigation | MVP-002, DEC-002, DEC-005 |
