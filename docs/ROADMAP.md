...
- **Current implementation task:** `MVP-005` — `Verify`; awaiting the orchestrator's review, verifier and merge.
- **Next implementation task:** `MVP-007` — `Draft`; its dependencies (MVP-002, MVP-004) are Done, and it is promoted to `Ready` when `MVP-005` reaches `Done` (`docs/task/SEQUENCE.txt` step 9).
...
| MVP-005 | Verify | Planning cycle and meal scope | MVP-002, MVP-004 |
